      ...
      <div className='p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar'>
        ...
        <div>
         ...
         {expandedSections.followers && (
            <select className='w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 outline-indigo-500' value={filters.minFollowers?.toString() || "0"} onChange={(e)=>onFiltersChange({...filters, minFollowers: parseInt(e.target.value) || 0})}>
        ...
        <div>
         ...
         {expandedSections.niche && (
            <select className='w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 outline-indigo-500' value={filters.niche || ""} onChange={(e)=>onFiltersChange({...filters, niche: e.target.value || null})}>
