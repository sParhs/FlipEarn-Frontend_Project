import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, PlusIcon, StarIcon, TrashIcon, TrendingUp, Users, WalletIcon, XCircle } from 'lucide-react'
...
const MyListings = () => {
  ...
  const formatNumber = (num)=>{
    if(num >= 1000000) return (num/10000).toFixed(1) + "M";
      ...
      (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
           {userListings.map((listing)=>(
            <div key={listing.id} className='bg-white rounded-lg border border-gray-200 hover:shadow-lg shadow-gray-200/7- transition-shadow'>
              <div className='p-6'>
