      ...
      <div className='mb-8'>
        ...
        <form onSubmit={handleSubmit} className='space-y-8'>
          {/* {BASIC INFO} */}
           ...
           {/* {Pricing} */}
           <Section title='Pricing & Decription'>
             <InputField label='Asking Price (USD) *' type='number' min={0} value={formData.country} placeholder='2500.00' onChange={(v) => handleInputChange('price', v)} required={true}/>
...
const CheckboxField = ({label, checked, onChange, required = false})=>(
  <label className='flex itmes-center space-x-2 cursor pointer'>
