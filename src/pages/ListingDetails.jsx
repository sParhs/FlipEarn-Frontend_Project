...
import { ArrowLeftIcon, ArrowUpRightFromSquare, ArrowUpRightFromSquareIcon, CheckCircle2, Loader2Icon, DollarSign, ChevronLeftIcon, ChevronRightIcon, Users, LineChart, Eye, Calendar, MapPin, MessageSquareMoreIcon, ShoppingBagIcon } from 'lucide-react';
  ...
  return listing ?  (
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
        <button className='flex items-center gap-2 text-slate-600 py-5'>
          <ArrowLeftIcon className='size-4'/> Got to Previous Page
        </button>
        ...
        <div className='flex items-start max-md:flex-col gap-10'>
              ...
              <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
                ...
                <div className='flex items-start gap-3'>
                 ...
                 <div>
                  ...
                  <Link target='blank' to={profileLink}>
          ...
          {/* {Additional details} */}
           <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className='grid frid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm'>
              <div>
          ...
          <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10'>
            ...
            <div className='flex items-center justify-between text-sm text-gray-600 mb-4'>
              <p>Member Since <spa className='font-medium'>{new Date(listing.owner?.createdAt).toLocaleDateString()}</spa></p>
            </div>
    ...
    <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
       <p className='text-sm text-gray-500'>
        © 2026 <span className='text-indigo-600'>Sparsh</span> . All rights reserved.
       </p>
    </div>
